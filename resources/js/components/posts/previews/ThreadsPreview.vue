...
<template>
    <div
        class="flex h-full w-full flex-col overflow-hidden bg-white text-[#000000] dark:bg-[#101010] dark:text-[#f5f5f5]"
    >
        <!-- Mobile Header -->
        <div
            class="flex h-11 flex-shrink-0 items-center justify-between border-b border-[#e0e0e0] px-4 dark:border-[#262626]"
        >
            <!-- Back arrow -->
            <button class="-ml-1 p-1">
                <svg
                    class="h-6 w-6 text-[#000000] dark:text-[#f5f5f5]"
                    viewBox="0 0 24 24"
                    fill="none"
                    stroke="currentColor"
                    stroke-width="2"
            ...
            <!-- Threads Logo -->
            <svg class="h-7 w-7" viewBox="0 0 192 192" fill="currentColor">
                <path
            ...
            <div class="px-4 pt-3 pb-2">
                ...
                <div class="flex items-center gap-2.5">
                    ...
                    >
                        ...
                        <div
                            v-else
                            class="flex h-full w-full items-center justify-center bg-gradient-to-br from-[#833ab4] via-[#fd1d1d] to-[#fcb045] text-sm font-bold text-white"
                        >
                            {{
                    ...
                    <div class="flex min-w-0 items-center gap-1">
                        <span
                            class="truncate text-[15px] font-semibold text-[#000000] dark:text-[#f5f5f5]"
                        >
                            {{ username }}
                        </span>
                        <!-- Verified badge -->
                        <svg
                            class="h-3.5 w-3.5 flex-shrink-0 text-[#0095f6]"
                            viewBox="0 0 40 40"
                            fill="currentColor"
                        >
                            <path
                ...
                <div
                    v-if="content"
                    class="mt-3 text-[15px] leading-[22px] whitespace-pre-wrap text-[#000000] dark:text-[#f5f5f5]"
                >
                    {{ content }}
                </div>
