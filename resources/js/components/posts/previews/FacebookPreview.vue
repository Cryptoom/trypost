...
const feedAspectPadding = computed<number | null>(
    () => ASPECT_PADDING[props.meta?.aspect_ratio ?? ''] ?? null,
);
...
const feedMediaProps = {
    ...
    placeholderClass:
        'w-full h-full flex items-center justify-center bg-[#f0f2f5] dark:bg-[#3a3b3c]',
};
                ...
                >
                    ...
                    >
                        <div class="absolute inset-0">
                            <PostMediaPreview
                                :media="media"
                                v-bind="feedMediaProps"
                            />
                        </div>
                    </div>
                    <div v-else class="relative min-h-0 flex-1 bg-black">
                        <PostMediaPreview
                            :media="media"
                            v-bind="feedMediaProps"
                        />
