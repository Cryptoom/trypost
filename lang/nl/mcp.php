...
return [
    'title' => 'MCP',
    'subtitle' => 'Koppel AI-assistenten zodat ze posts kunnen maken en beheren met je TryPost-account.',
    ...
    'connected_description' => 'Assistenten waarmee iemand op dit account is ingelogd. Je kunt alleen je eigen apps ontkoppelen.',
    'connected_empty' => 'Nog niets gekoppeld. Gebruik Claude, ChatGPT of een andere client hierboven.',
    'connected_by' => 'Verbonden door :name',
