...
return [
    ...
    'processing' => [
        ...
        'success_description' => 'Ваша подписка активна. Перенаправление…',
        'cancelled_title' => 'Оформление отменено',
        'cancelled_description' => 'Оформление отменено. Списаний не было.',
        'retry' => 'Попробовать снова',
        'taking_long' => 'Это занимает больше времени, чем ожидалось, — подождите, мы всё ещё настраиваем аккаунт.',
        'live' => 'Live',
    ],
];
