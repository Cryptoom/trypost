...
return [
    ...
    'continue' => 'Продолжить',
    'checkout_owner_only' => 'Попросите владельца аккаунта завершить оплату и оформить подписку.',
    'checkout_trial_note' => 'Бесплатный пробный период :days дн., затем :plan оплачивается ежемесячно. Отмена в любое время.',
    'checkout_plan_note' => 'После оформления :plan оплачивается ежемесячно.',
