...
return [
    'title' => 'MCP',
    'subtitle' => 'Подключайте AI-клиенты к TryPost через размещённый MCP-сервер.',
    'connect_title' => 'Connect a client',
    'connect_description' => 'Установите TryPost в MCP-клиенте ниже. OAuth запускается автоматически при первом запросе.',
