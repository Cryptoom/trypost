...
return [
    ...
    'connected_description' => 'Bu hesaptaki herhangi birinin giriş yaptığı asistanlar. Yalnızca kendininkileri bağlantıyı kesebilirsiniz.',
    'connected_empty' => 'Henüz bağlı bir şey yok. Yukarıdan Claude, ChatGPT veya başka bir istemci kullanın.',
    'connected_by' => ':name tarafından bağlandı',
