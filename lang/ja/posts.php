...
return [
    ...
    'form' => [
        ...
        'instagram' => [
            ...
            'collaborators_placeholder' => 'Instagramのユーザー名を追加',
            'collaborators_hint' => '招待されたアカウントは承認する必要があります。非公開、年齢制限、コラボ招待オフのアカウントは拒否されます。最大3件。',
            'collaborators_max' => 'コラボレーターは最大3人まで招待できます。',
            'collaborators_invalid' => '有効なInstagramユーザー名を入力してください。',
            'collaborators_self' => '接続中のInstagramアカウントをコラボレーターに追加することはできません。',
            'collaborators_pending' => '保留中',
            'collaborators_accepted' => '承認済み',
            'collaborators_declined' => '辞退',
            'collaborators_status_unavailable' => '招待を送信しました。リアルタイムのステータスはFacebook経由のInstagramでのみ利用できます。',
            'collaborators_with' => ':names と',
        ],
        'facebook' => [
