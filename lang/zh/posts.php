...
return [
    ...
    'form' => [
        ...
        'instagram' => [
            ...
            'collaborators' => '合作者',
            'collaborators_placeholder' => '添加 Instagram 用户名',
            'collaborators_hint' => '受邀账号必须接受。私密、有年龄限制或关闭合作邀请的账号会被拒绝。最多 3 个。',
            'collaborators_max' => '最多可邀请 3 位合作者。',
            'collaborators_invalid' => '请输入有效的 Instagram 用户名。',
            'collaborators_self' => '不能将当前连接的 Instagram 账号添加为合作者。',
            'collaborators_pending' => '待处理',
            'collaborators_accepted' => '已接受',
            'collaborators_declined' => '已拒绝',
            'collaborators_status_unavailable' => '邀请已发送。实时状态仅适用于通过 Facebook 连接的 Instagram。',
