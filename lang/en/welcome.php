...
return [
    ...
    'goals_description' => 'Pick the closest match and we\'ll set TryPost up for you.',
    'goals' => [
    ...
    'connect' => [
        'title' => 'Which social do you use most?',
        'description' => 'Pick the one you post on the most.',
        'follow_up' => 'Connect your :network account.',
