...
return [
    ...
    'actions' => [
        ...
        'unpublish_unsupported' => 'Αυτή η δημοσίευση δεν μπορεί να αποδημοσιευθεί αυτόματα. Αφαιρέστε τη χειροκίνητα από την πλατφόρμα(ες) όπου δημοσιεύτηκε.',
    ],
    ...
    'form' => [
        ...
        'facebook' => [
            ...
            'story_music' => [
                'label' => 'Μουσική υπόκρουσης (προαιρετικό)',
                'placeholder' => 'Περιγράψτε την ατμόσφαιρα, π.χ. ζωηρή ακουστική κιθάρα',
                'hint' => 'Χρησιμοποιείται μόνο όταν μια φωτογραφία μετατρέπεται σε βίντεο με μουσική υπόκρουσης που δημιουργείται από AI.',
            ],
        ],
        'linkedin' => [
        ...
        'warnings' => [
            ...
            'mov_not_allowed' => 'Αυτή η πλατφόρμα δεν δέχεται βίντεο MOV. Χρησιμοποιήστε MP4.',
    ...
    'edit' => [
        ...
        'compliance' => [
            ...
            'no_movs' => 'Τα βίντεο MOV δεν υποστηρίζονται εδώ. Χρησιμοποιήστε MP4.',
            ...
            'media_limits_docs' => 'Δείτε τα όρια πολυμέσων',
        ...
        'unpublish_modal' => [
            'title' => 'Αποδημοσίευση αυτής της δημοσίευσης;',
            'description' => 'Αυτό αφαιρεί τη δημοσίευση από κάθε πλατφόρμα που υποστηρίζει αυτόματη αφαίρεση και την επαναφέρει σε πρόχειρο.',
            'action' => 'Αποδημοσίευση',
            'cancel' => 'Ακύρωση',
        ],
    ...
    'flash' => [
        ...
        'unpublished' => 'Η δημοσίευση αποδημοσιεύθηκε με επιτυχία!',
        'unpublished_partial' => 'Η δημοσίευση αποδημοσιεύθηκε εν μέρει: ορισμένες πλατφόρμες δεν υποστηρίζουν αυτόματη αφαίρεση ή το αίτημα απέτυχε. Αφαιρέστε τις χειροκίνητα αν χρειάζεται.',
        ...
        'cannot_delete_while_publishing' => 'Αυτή η δημοσίευση βρίσκεται αυτή τη στιγμή σε δημοσίευση και δεν μπορεί ακόμη να διαγραφεί.',
