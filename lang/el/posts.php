...
return [
    ...
    'form' => [
        ...
        'instagram' => [
            ...
            'collaborators_hint' => 'Προαιρετικό. Οι προσκεκλημένοι λογαριασμοί πρέπει να αποδεχτούν. Ιδιωτικοί, με όριο ηλικίας ή με απενεργοποιημένες προσκλήσεις collab απορρίπτονται. Μέγ. 3.',
            ...
            'collaborators_duplicate' => 'Αυτός ο συνεργάτης έχει ήδη προστεθεί.',
