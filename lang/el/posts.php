...
return [
    ...
    'form' => [
        ...
        'instagram' => [
            ...
            'collaborators_placeholder' => 'Προσθήκη ονόματος χρήστη Instagram',
            'collaborators_hint' => 'Οι προσκεκλημένοι λογαριασμοί πρέπει να αποδεχτούν. Ιδιωτικοί, με όριο ηλικίας ή με απενεργοποιημένες προσκλήσεις collab απορρίπτονται. Μέγ. 3.',
            'collaborators_max' => 'Μπορείτε να προσκαλέσετε έως 3 συνεργάτες.',
            'collaborators_invalid' => 'Εισαγάγετε έγκυρο όνομα χρήστη Instagram.',
            'collaborators_self' => 'Δεν μπορείτε να προσθέσετε αυτόν τον συνδεδεμένο λογαριασμό Instagram ως συνεργάτη.',
            'collaborators_pending' => 'Σε εκκρεμότητα',
            'collaborators_accepted' => 'Αποδεκτό',
            'collaborators_declined' => 'Απορρίφθηκε',
            'collaborators_status_unavailable' => 'Η πρόσκληση στάλθηκε. Η ζωντανή κατάσταση είναι διαθέσιμη μόνο για Instagram μέσω Facebook.',
            'collaborators_with' => 'με :names',
        ],
        'facebook' => [
