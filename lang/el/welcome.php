...
return [
    ...
    'continue' => 'Συνέχεια',
    'checkout_owner_only' => 'Ζητήστε από τον κάτοχο του λογαριασμού να ολοκληρώσει την πληρωμή και να ξεκινήσει τη συνδρομή.',
    'checkout_trial_note' => 'Δωρεάν δοκιμή :days ημερών, μετά το :plan χρεώνεται μηνιαίως. Ακυρώστε όποτε θέλετε.',
    'checkout_plan_note' => 'Μετά την ολοκλήρωση, το :plan χρεώνεται μηνιαίως.',
