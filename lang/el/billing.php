...
return [
    ...
    'processing' => [
        ...
        'success_description' => 'Η συνδρομή σας είναι ενεργή. Ανακατεύθυνση…',
        'cancelled_title' => 'Η πληρωμή ακυρώθηκε',
        'cancelled_description' => 'Η πληρωμή σας ακυρώθηκε. Δεν έγινε καμία χρέωση.',
        'retry' => 'Δοκιμάστε ξανά',
        'taking_long' => 'Παίρνει περισσότερο από το αναμενόμενο — περιμένετε, συνεχίζουμε τη ρύθμιση.',
        'continue' => 'Συνέχεια στην εφαρμογή',
        'live' => 'Ζωντανά',
    ],
];
