...
return [
    'title' => 'MCP',
    'subtitle' => 'Connect AI clients to TryPost through the hosted MCP server.',
    'connect_title' => 'Connect a client',
    'connect_description' => 'Install TryPost in your MCP client below. OAuth runs automatically on the first request.',
