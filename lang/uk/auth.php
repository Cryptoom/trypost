...
return [
    ...
    */
    ...
    'reviews' => [
        'eyebrow' => '5/5 на G2',
        'heading' => 'Вибір тих, хто публікує',
        'paulo_dantas' => [
            'role' => 'Засновник, chatadv.com.br',
            'quote' => 'Простота створення, впорядкування та поширення контенту в усіх соціальних мережах. Із MCP ми можемо використовувати той ШІ, який хочемо, як-от Claude чи ChatGPT, щоб створювати контент і одразу планувати публікації.',
        ],
        'diego' => [
            'role' => 'CEO, Globalfy.com',
            'quote' => 'Мені подобається, наскільки TryPost простий. Я створюю допис просто в Claude, а потім через MCP публікую його та планую на майбутнє. Налаштував за п\'ять хвилин.',
        ],
        'luiz' => [
            'role' => 'Контент-креатор',
            'quote' => 'Обожнюю, як легко підключати мої ШІ-інструменти та агентів і планувати дописи в 9 соціальних мережах за кілька хвилин.',
        ],
        'pedro' => [
            'role' => 'Засновник, templated.io',
            'quote' => 'Дуже легко користуватися та інтегрувати. З MCP інтерфейс потрібен лише для підключення акаунтів соцмереж.',
        ],
        'paulo_castellano' => [
            'role' => 'Засновник, changelogfy.com',
            'quote' => 'Обожнюю інтеграцію з MCP, адже вона дає змогу керувати всіма моїми акаунтами в соцмережах із Claude або ChatGPT.',
        ],
    ],
