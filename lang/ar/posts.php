...
return [
    ...
    'form' => [
        ...
        'instagram' => [
            ...
            'collaborators_hint' => 'اختياري. يجب أن تقبل الحسابات المدعوة. تُرفض الحسابات الخاصة أو المقيدة بالعمر أو التي أوقفت دعوات التعاون. الحد الأقصى 3.',
            'collaborators_max' => 'يمكنك دعوة ما يصل إلى 3 متعاونين.',
            'collaborators_invalid' => 'أدخل اسم مستخدم إنستغرام صالحًا.',
            'collaborators_duplicate' => 'تمت إضافة هذا المتعاون بالفعل.',
