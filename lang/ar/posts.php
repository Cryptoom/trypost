...
return [
    ...
    'form' => [
        ...
        'instagram' => [
            ...
            'collaborators_placeholder' => 'أضف اسم مستخدم إنستغرام',
            'collaborators_hint' => 'يجب أن تقبل الحسابات المدعوة. تُرفض الحسابات الخاصة أو المقيدة بالعمر أو التي أوقفت دعوات التعاون. الحد الأقصى 3.',
            'collaborators_max' => 'يمكنك دعوة ما يصل إلى 3 متعاونين.',
            'collaborators_invalid' => 'أدخل اسم مستخدم إنستغرام صالحًا.',
            'collaborators_self' => 'لا يمكنك إضافة حساب إنستغرام المتصل هذا كمتعاون.',
            'collaborators_pending' => 'قيد الانتظار',
            'collaborators_accepted' => 'مقبول',
            'collaborators_declined' => 'مرفوض',
            'collaborators_status_unavailable' => 'تم إرسال الدعوة. الحالة المباشرة متاحة فقط لإنستغرام المتصل عبر فيسبوك.',
            'collaborators_with' => 'مع :names',
        ],
        'facebook' => [
