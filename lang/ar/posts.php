...
return [
    ...
    'actions' => [
        ...
        'unpublish_unsupported' => 'لا يمكن إلغاء نشر هذا المنشور تلقائيًا. احذفه يدويًا من المنصة (المنصات) التي نُشر عليها.',
    ],
    ...
    'form' => [
        ...
        'facebook' => [
            ...
            'story_music' => [
                'label' => 'موسيقى خلفية (اختياري)',
                'placeholder' => 'صف الأجواء، مثل جيتار أكوستيك مبهج',
                'hint' => 'تُستخدم فقط عند تحويل صورة إلى فيديو بموسيقى خلفية مُولّدة بالذكاء الاصطناعي.',
            ],
        ],
        'linkedin' => [
        ...
        'warnings' => [
            ...
            'mov_not_allowed' => 'لا تقبل هذه المنصة فيديوهات MOV. استخدم MP4.',
    ...
    'edit' => [
        ...
        'compliance' => [
            ...
            'no_movs' => 'فيديوهات MOV غير مدعومة هنا. استخدم MP4.',
            ...
            'media_limits_docs' => 'عرض حدود الوسائط',
        ...
        'unpublish_modal' => [
            'title' => 'هل تريد إلغاء نشر هذا المنشور؟',
            'description' => 'سيؤدي هذا إلى إزالة المنشور من كل منصة تدعم الحذف التلقائي، وإعادته إلى المسودات.',
            'action' => 'إلغاء النشر',
            'cancel' => 'إلغاء',
        ],
    ...
    'flash' => [
        ...
        'unpublished' => 'تم إلغاء نشر المنشور بنجاح!',
        'unpublished_partial' => 'تم إلغاء نشر المنشور جزئيًا: بعض المنصات لا تدعم الحذف التلقائي أو فشل الطلب. احذفها يدويًا إذا لزم الأمر.',
        'cannot_edit_finalized' => 'تمت معالجة هذا المنشور بالفعل ولا يمكن إعادة نشره. كرّره للمحاولة مرة أخرى.',
        'cannot_delete_while_publishing' => 'هذا المنشور قيد النشر حاليًا ولا يمكن حذفه بعد.',
