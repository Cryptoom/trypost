...
return [
    ...
    */
    ...
    'reviews' => [
        'eyebrow' => '5/5 على G2',
        'heading' => 'محبوب لدى من ينشرون كل يوم',
        'paulo_dantas' => [
            'role' => 'المؤسس، chatadv.com.br',
            'quote' => 'بساطة إنشاء المحتوى وتنظيمه وتوزيعه على جميع الشبكات الاجتماعية. مع MCP يمكننا استخدام الذكاء الاصطناعي الذي نفضله، مثل Claude أو ChatGPT، لإنشاء المحتوى وجدولته من هناك.',
        ],
        'diego' => [
            'role' => 'الرئيس التنفيذي، Globalfy.com',
            'quote' => 'أحب سهولة استخدام TryPost. يمكنني إنشاء منشور مباشرة في Claude ثم استخدام MCP لنشره وجدولته لاحقًا. أعددت كل شيء في خمس دقائق.',
        ],
        'luiz' => [
            'role' => 'صانع محتوى',
            'quote' => 'أحب كم هو سهل ربط أدوات ووكلاء الذكاء الاصطناعي لدي وجدولة منشوراتي على 9 منصات تواصل اجتماعي في دقائق.',
        ],
        'pedro' => [
            'role' => 'المؤسس، templated.io',
            'quote' => 'سهل الاستخدام والدمج فعلاً. مع MCP أحتاج الواجهة فقط لربط حسابات التواصل الاجتماعي.',
        ],
        'paulo_castellano' => [
            'role' => 'المؤسس، changelogfy.com',
            'quote' => 'أحب تكامل MCP لأنه يتيح لي تنظيم جميع حسابات التواصل الاجتماعي من Claude أو ChatGPT.',
        ],
    ],
