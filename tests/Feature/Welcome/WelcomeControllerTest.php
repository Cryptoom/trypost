...
test('legacy onboarding routes are not registered', function (string $routeName) {
    expect(Route::has($routeName))->toBeFalse();
})->with([
    'goals' => 'app.legacy-onboarding.goals',
    'referral source' => 'app.legacy-onboarding.referral-source',
    'connect' => 'app.legacy-onboarding.connect',
    'persona store' => 'app.legacy-onboarding.store',
    'goals store' => 'app.legacy-onboarding.goals.store',
    'referral source store' => 'app.legacy-onboarding.referral-source.store',
    'checkout' => 'app.legacy-onboarding.checkout',
]);
